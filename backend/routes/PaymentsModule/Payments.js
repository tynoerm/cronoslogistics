...
import paymentSchema from "../../models/PaymentsModule/Payments.js";  // Updated import
...
router.get("/download/pdf", async (req, res) => {
  try {
    const files = await paymentSchema.find();  // Updated schema reference
...
export { router as paymentRoutes };  // Updated export name
