...
const Expenses = () => {
  ...
  useEffect(() => {
    axios.get("https://cronoslogistics.onrender.com/expense/")
        .then(res => setExpensesForm(res.data.data)) // Update state with fetched payments
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("https://cronoslogistics.onrender.com/expense/create-expense", expensesInsert)
      .then((res) => {
  ...
  const handleDownload = async (type) => {
    try {
      const response = await axios.get(`https://cronoslogistics.onrender.com/expense/download/${type}`, {
