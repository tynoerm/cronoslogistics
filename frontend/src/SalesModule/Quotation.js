...
const Quotation = () => {
    ...
    useEffect(() => {
        axios.get("https://accounting-system-1.onrender.com/quotation")
    ...
    const handleSubmit = (e) => {
        ...
        axios.post("https://accounting-system-1.onrender.com/quotation/create-quote", quotationInsert)
            .then(() => {
    ...
    const handleDownload = async (type) => {
        try {
            const response = await axios.get(`https://accounting-system-1.onrender.com/quotation/download/${type}`, { responseType: "blob" });
